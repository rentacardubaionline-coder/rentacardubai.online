...
import { VendorCardWhatsappButton } from "@/components/vendor/vendor-card-whatsapp-button";
...
interface VendorCardProps {
  ...
  /** Source string passed to the lead-capture modal so we can attribute the
   *  click in the leads table (e.g. "search_results", "city_fallback"). */
  source?: string;
}

export function VendorCard({ vendor, source = "vendor_card" }: VendorCardProps) {
  ...
  const hasWhatsApp = Boolean(vendor.whatsapp_phone || vendor.phone);
