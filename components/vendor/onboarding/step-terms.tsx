      ...
      >
        ...
        <div className="sticky top-0 z-10 border-b border-surface-muted bg-white/95 backdrop-blur-sm px-5 py-3">
          <p className="text-[11px] font-bold uppercase tracking-widest text-brand-600">
            RentNowPk — Vendor Agreement
          </p>
          <p className="text-xs text-ink-400 mt-0.5">April 2026 · Read fully before accepting</p>
        </div>
        ...
        <div className="px-5 py-5 space-y-1">
          ...
          <DocSection icon={ListChecks} title="How It Works">
            <p>When a customer is interested in your car, they submit an <strong>enquiry (lead)</strong>. You receive the customer&apos;s contact details, dates, and requirements instantly. You then negotiate and confirm the booking directly with the customer — RentNowPk does not handle the booking transaction.</p>
          </DocSection>
          ...
          <div className="rounded-xl border-2 border-brand-200 bg-brand-50 p-4 mb-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-extrabold text-brand-900">Billing & Charges</h3>
            </div>
            <ul className="space-y-2.5 text-sm text-ink-700">
              ...
              <BulletItem>
                <strong>First-month proration</strong> — your first invoice covers only from your activation date to month end.
              </BulletItem>
              <BulletItem>
                <strong>No refunds</strong> for leads that don&apos;t convert into bookings.
              </BulletItem>
            </ul>
          </div>
          ...
          <DocSection icon={Banknote} title="Payment">
            <p>Invoices are issued manually by our admin team. You must pay within <strong>7 days</strong> of the invoice date via bank transfer, Easypaisa, or JazzCash (details on each invoice). Accounts overdue beyond <strong>14 days</strong> are suspended until the balance is cleared.</p>
          </DocSection>

          {/* ── Section 4: Your obligations ── */}
          <DocSection icon={ListChecks} title="Your Obligations">
            <ul className="space-y-2 mt-1">
              <BulletItem><strong>Respond within 24 hours</strong> to every lead. Repeated non-responses trigger an account review.</BulletItem>
              <BulletItem><strong>Honour confirmed bookings.</strong> Once you confirm — by call, WhatsApp, or message — you are obligated to fulfil it.</BulletItem>
              <BulletItem><strong>Keep listings accurate.</strong> Real photos, correct specs, genuine availability. No stock images.</BulletItem>
              <BulletItem><strong>Keep contact details reachable.</strong> Unreachable phone or WhatsApp is a suspension trigger.</BulletItem>
            </ul>
          </DocSection>
          ...
          <DocSection icon={ShieldAlert} title="Account Suspension">
            ...
            <ul className="space-y-1.5">
              <BulletItem>3+ unresolved customer complaints within 60 days</BulletItem>
              ...
              <BulletItem>Repeatedly ignoring leads or cancelling confirmed bookings</BulletItem>
            </ul>
            <p className="mt-2 text-xs text-ink-400">You will be notified by email and given 7 days to respond before permanent removal.</p>
          </DocSection>

          {/* ── Section 6: Disputes & Rate changes ── */}
          <DocSection icon={MessageCircle} title="Disputes & Rate Changes">
            <p className="mb-2"><strong>Disputes:</strong> Raise within 7 days of invoice date at <strong>support@rentnowpk.com</strong> with your invoice number. Our decision is final.</p>
            <p><strong>Rate changes:</strong> We will give 30 days&apos; email notice before changing the per-lead rate. Continued use = acceptance of new rates.</p>
          </DocSection>

          {/* ── Document footer ── */}
          <div className="mt-5 rounded-xl border border-surface-muted bg-surface-muted/30 px-4 py-3.5 text-center">
            <p className="text-xs text-ink-500 leading-relaxed">
              Clicking <strong className="text-ink-700">&ldquo;I Agree &amp; Continue&rdquo;</strong> creates a legally binding agreement. A confirmation email will be sent to your registered address as your record.
            </p>
          </div>
...
function KeyFact({
  ...
  return (
    <div className="flex items-start gap-2.5 rounded-xl border border-surface-muted bg-white p-3">
      <div className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-lg ${colors[color]}`}>
        <Icon className="h-3.5 w-3.5" />
      </div>
      <div>
        <p className="text-[10px] font-semibold uppercase tracking-wider text-ink-400">{label}</p>
        <p className="text-xs font-bold text-ink-900 leading-tight mt-0.5">{value}</p>
      </div>
    </div>
  );
}
...
function DocSection({
  ...
  return (
    <div className="border-t border-surface-muted pt-4 pb-1">
      ...
      <div className="text-sm text-ink-600 leading-relaxed pl-[1.375rem]">{children}</div>
    </div>
  );
}
