...
export function InstallPrompt() {
  ...
  return (
    <>
      ...
      {showIosSheet && (
        <InstructionalSheet
          title="Add RentNowPK to your home screen"
      ...
      {showAndroidSheet && (
        <InstructionalSheet
          ...
          steps={[
            ...
            <>
              Confirm — RentNowPK opens like a native app from your home screen.
            </>,
          ]}
