...
export function GenericLanding({
  h1,
  resolved,
  allCities,
  listings,
  ...
  let desc = "Compare verified rental vendors and book with ease.";
  ...
  if (resolved.city && resolved.model) {
    ...
    desc = `Looking for a rental car near ${resolved.town.name}, ${resolved.city.name}? Browse local vendors, compare prices, and book with ease.`;
    ...
    desc = `Rent a ${resolved.model.brand.name} ${resolved.model.name} from verified vendors. Compare prices in Dubai and book with ease.`;
  } else if (resolved.filter) {
    const filterLabel = resolved.filter
      .split("-")
          ...
          {[
            {
              ...
              step: "01",
              title: "Pick Your Car",
              desc: "Browse real listings with verified prices. Filter by location, model, or budget.",
            ...
            },
            {
              ...
              desc: "Tap WhatsApp to message the vendor directly. Confirm dates, pricing, and pickup.",
            ...
            },
            {
              ...
              step: "03",
              title: "Book & Go",
              desc: "Lock your booking with ease. Pay the rest at pickup. No hidden charges.",
