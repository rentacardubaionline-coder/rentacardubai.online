...
export default function VendorsError({
  ...
  useEffect(() => {
    console.error("[vendors/error.tsx]", error);
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 md:px-6 py-16 text-center">
      ...
      <h1 className="text-2xl font-black text-ink-900">We can&rsquo;t load the vendors right now.</h1>
      <p className="mt-2 text-sm text-ink-600 max-w-md mx-auto">
        A temporary error stopped the directory from loading. Try again — most
        issues clear in seconds.
      </p>
