...
export const alt = "RentNowPk — Pakistan's car rental marketplace";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span>RentNow</span>
          <span style={{ color: "#ffe4d1" }}>Pk</span>
        </div>
        ...
        >
          Rent a car in Pakistan from verified vendors — book via WhatsApp
        </div>
        ...
        >
          {["Verified vendors", "No hidden charges", "Instant WhatsApp booking"].map(
            (label) => (
              <div
                key={label}
                style={{
