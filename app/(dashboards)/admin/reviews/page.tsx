...
export default async function AdminReviewsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-ink-900">Vendor Reviews</h1>
        <p className="mt-2 text-ink-600">
          Add and manage customer reviews for each vendor. Aggregates update automatically.
        </p>
      </div>
